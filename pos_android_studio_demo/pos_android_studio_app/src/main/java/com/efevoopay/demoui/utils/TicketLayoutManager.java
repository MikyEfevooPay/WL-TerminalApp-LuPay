...
public class TicketLayoutManager {
    ...
    public void setTicketDataByLayout(Ticket ticket) {
        TextView txt_company, txt_address_1, txt_address_2, txt_address_3, txt_transaction_type,
                txt_ticket_date, txt_ticket_card, txt_ticket_card_type, txt_ticket_consumo_value,
                txt_ticket_tip_value, txt_ticket_total_value, txt_ticket_status,txt_ticket_entity_type,
                txt_ticket_kposId, txt_ticket_aid, txt_ticket_arqc;
        ...
        switch (this.type) {
            case TRANSACTION:
                ...
                txt_ticket_card_type.setText(ticket.getCard_type());
                ...
                txt_ticket_status.setText("APROBADA");
                ...
                txt_ticket_arqc.setText("ARQC  " + ticket.getARQC());
                break;
            case CORTE:
                txt_company = layout.findViewById(R.id.txt_company);
                txt_address_1 = layout.findViewById(R.id.txt_address_1);
